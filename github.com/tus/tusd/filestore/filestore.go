...
func (store FileStore) ConcatUploads(dest, pid string, uploads []string) (err error) {
...
func (store FileStore) GeturlAddr(objectName string, offset int64) (string, error) {
